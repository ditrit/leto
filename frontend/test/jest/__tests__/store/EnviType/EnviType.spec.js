...
describe("Store: EnviType", () => {
	...
	describe("Test: mutations", () => {
		...
		it("Test method: UPDATE_ENVITYPE", () => {
			...
			store.mutations.UPDATE_ENVITYPE(state, { ID: 1, FirstName: "Test1" });
			expect(state.enviTypes).toEqual([
				{ ID: 1, FirstName: "Test1" },
				{ ID: 2 },
			]);

			store.mutations.UPDATE_ENVITYPE(state, { ID: 2, FirstName: "Test2" });
			expect(state.enviTypes).toEqual([
				{ ID: 1, FirstName: "Test1" },
		...
		it("Test method: DELETE_ENVITYPE", () => {
			...
			expect(state.enviTypes).toHaveLength(2);
